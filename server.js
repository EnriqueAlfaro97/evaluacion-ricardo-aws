// //server.js
// ---------------------------------------------------------------------------
//  evaluacion-ricardo · servidor de la práctica de EKS
//
...
<title>evaluacion-ricardo · Clúster EKS con pipeline</title>
    ...
    <figure>
      <div class="diagrama">
        <svg viewBox="0 0 900 260" role="img" aria-label="Flujo completo: git push dispara GitHub Actions, que asume un rol por OIDC, sube la imagen a ECR, actualiza el Deployment en EKS, y el ALB entrega el tráfico a los pods">
          ...
          <text class="dx-t" x="639" y="90" text-anchor="middle" font-size="12">pod evaluacion-ricardo-1</text>
          <rect class="dx-b" x="580" y="122" width="118" height="46" rx="7"></rect>
          <text class="dx-t" x="639" y="150" text-anchor="middle" font-size="12">pod evaluacion-ricardo-2</text>
    ...
    <div class="tw">
      <table>
        ...
        <tbody>
          ...
          <tr><td><code>deployments.apps "evaluacion-ricardo" not found</code></td><td>No se había borrado nada: faltaba el namespace en el comando. Kubernetes contestó exactamente la pregunta que se le hizo.</td></tr>
...
<footer>
  <div class="wrap">
    <div><b>Aplicación</b><code>evaluacion-ricardo · ${esc(d.version)}</code></div>
